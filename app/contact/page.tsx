  ...
  return (
    <div className="space-y-16">
      <header className="animate-fade-in-up">
        ...
        <h1 className="text-4xl font-normal text-bright tracking-tight">contact</h1>
      ...
      <section className="space-y-10 animate-fade-in-delay-1 opacity-0">
        ...
        <div className="flex flex-col gap-6 pt-4">
          <a
            ...
            className="inline-block text-bright hover:text-accent transition-colors duration-300 text-lg py-2 border-b border-border/50 hover:border-accent/30 w-fit"
          >
            email
          </a>
          <a
